...
INSERT INTO `oc_api` VALUES (1,'Default','',1,'2022-10-05 22:19:47','2022-10-05 22:19:47');
...
--
-- ORDER BY:  `customer_affiliate_report_id`
...
--
-- ORDER BY:  `product_id`,`subscription_plan_id`,`customer_group_id`
...
INSERT INTO `oc_session` VALUES ('1e0c00bec406f6c62c553537aa','{\"user_id\":\"1\",\"user_token\":\"b5bf737c07ee9f132c063058d89d85dd\"}','2022-10-06 20:21:13'),('5ee55bbc53954ad26ffeeb7bc7','{\"currency\":\"USD\"}','2022-10-08 08:12:57'),('ae8e008227d79c057827f4f515','{\"currency\":\"USD\"}','2022-10-08 08:12:57');
...
) ENGINE=InnoDB AUTO_INCREMENT=211 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- ORDER BY:  `subscription_history_id`
...
--
-- ORDER BY:  `subscription_plan_id`,`language_id`
...
--
-- ORDER BY:  `subscription_status_id`,`language_id`
...
--
-- ORDER BY:  `subscription_transaction_id`
...
INSERT INTO `oc_user` VALUES (1,1,'admin','$2y$10$.WcopkbvRg01MtaRHBMd1eHJwrttbRb9/VaP.R/B2y7bCaq7jM01i','John','Doe','dstoeckm@cisco.com','','','10.61.98.151',1,'2022-10-05 22:19:47');
...
-- Dump completed on 2022-10-07 10:16:56
