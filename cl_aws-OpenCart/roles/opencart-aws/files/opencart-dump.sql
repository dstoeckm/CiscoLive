...
--
-- Host: terraform-20231117202044167600000001.cr9rir82q0mh.eu-central-1.rds.amazonaws.com    Database: opencart
-- ------------------------------------------------------
...
INSERT INTO `oc_api` VALUES (1,'sTALoQneclgvqnIgGCaMBojoZ8XSsUbbocmTtQxM2T7i7GFDIfPJKyyjxM1fhT6L','','','',1,'2023-11-17 20:44:42','2023-11-17 20:44:42');
...
) ENGINE=MyISAM AUTO_INCREMENT=428 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=284 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `oc_user` VALUES (1,1,'admin','def05817c450ffcbbd246ace3941d36e65e4e74e','496b2ae36','John','Doe','hier@da.de','','','',1,'2023-11-17 20:44:42');
...
CREATE TABLE `oc_zone` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`zone_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4231 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-17 20:47:42
